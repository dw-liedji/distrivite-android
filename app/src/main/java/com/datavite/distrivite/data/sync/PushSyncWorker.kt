...
class PushSyncWorker @AssistedInject constructor(
    ...
    object MultiSyncScheduler {
        ...
        const val UNIQUE_WORK_NAME = "PushSyncWorker"
        ...
        fun schedulePeriodicSync(
            ...
            val periodicWorkRequest = PeriodicWorkRequestBuilder<PushSyncWorker>(
    ...
    override suspend fun doWork(): Result {
        ...
        return try {
            Log.i(TAG, "Starting pushing changes...")
            syncOrchestrator.push(organization)
            Log.i(TAG, "Pushing changes completed.")
            Result.success()
