...
class BitmapUtils {
    ...
    companion object {
        ...
        fun cropRectFromBitmap(bitmap: Bitmap, rect: Rect ): Bitmap {
            ...
            if (width <= 0 || height <= 0) {
                throw IllegalArgumentException("Invalid cropping dimensions.")
            }
        ...
        fun flipHorizontally( source: Bitmap ): Bitmap {
            val matrix = Matrix()
        ...
        fun imageToBitmap( image : Image , rotationDegrees : Int ): Bitmap {
            ...
            return flipHorizontally( output )
        }
