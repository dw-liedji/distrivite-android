package com.datavite.distrivite.presentation.web
...
import com.ramcosta.composedestinations.generated.destinations.WebScreenDestination
...
@Composable
fun WebScreen(navigator: DestinationsNavigator) {

    val scrollBehavior = TopAppBarDefaults.pinnedScrollBehavior()
    val route = WebScreenDestination.route
    ...
    Scaffold(
        ...
        LaunchedEffect(webNavigator) {
            ...
            if (bundle == null) {
                webNavigator.loadUrl("https://www.distrivite.com/fr/users/account/")
            }
        }
